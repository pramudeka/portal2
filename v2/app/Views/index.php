    ...
    <body id="page-top" class=" d-flex  flex-column">
        ...
        <section class="page-section  flex-grow-1" id="portfolio">
            <div class="text-center headers">
                <img src="<?=base_url('/public')?>/assets/img/logo-header.png" class="img-fluid logo-header" alt="Mall Pelayanan Publik Kab. Blitar">
            </div>
            <div class="sticky-top kat">
                <div class="mini-headers">
                    <img src="<?=base_url('/public')?>/assets/img/logo-kab.png">
